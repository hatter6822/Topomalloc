...
**Test counts:**
- Rust: ~840 tests across 12 crates (`cargo test --workspace`); the W18 `hardened`
  profile and the POSIX/Sim hardening integration suite (guard-page SIGSEGV death
  test, live quarantine control) run as dedicated `cargo xtask test` passes
