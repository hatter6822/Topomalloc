...
- Sanitizers (W19-2, §30.3): `cargo xtask test --kind tsan|asan|msan` — ThreadSanitizer over
  the W6/W7 concurrency + W18 hardening, and **AddressSanitizer / MemorySanitizer** over the
