...
| `TopoMalloc/ExtentHooks.lean` | the §23.4 hook assumption: §23.3 contracts ⇒ alloc/split/merge/subrange preserve disjointness + tiling (conditional correctness) | W10 |
